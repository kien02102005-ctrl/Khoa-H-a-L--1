                ...
                sections: [{
                    ...
                    children: [
                        ...
                        new Paragraph({
                            spacing: { after: 200 },
                            children: [
                                new TextRun({ text: `Chức vụ: `, bold: true, font: "Times New Roman", size: 22 }),
                        ...
                        new Paragraph({
                            ...
                            spacing: { after: 300 },
                            children: [
                                new TextRun({ text: `PHIẾU ĐÁNH GIÁ KẾT QUẢ CÔNG VIỆC (${monthStr.toUpperCase()})`, bold: true, font: "Times New Roman", size: 26 })
                            ]
                        }),
                        new Table({
                            width: { size: 100, type: WidthType.PERCENTAGE },
